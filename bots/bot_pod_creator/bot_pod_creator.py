...
class BotPodCreator:
    def __init__(self):
        ...
        if not self.app_version:
            logger.error("CUBER_RELEASE_VERSION environment variable is required")
        ...
        logger.info(f"Bot Pod image: {self.image}")
    ...
    def get_bot_container(self):
        ...
        logger.info(f"Setting bot container with CPU request: {cpu_request}, memory request: {memory_request}, memory limit: {memory_limit}, and ephemeral storage request: {ephemeral_storage_request}")
